...
**************************************************************************** */
#ifndef __EDT_UTIL_PCSC_H__
#define __EDT_UTIL_PCSC_H__

#include <vector>
#include <Winscard.h>
//#include "reader.h"
#define EDT_PCSC_MAX_RETRIES	10
#define EDT_PCSC_RETRY_MS		100

int EDT_pcscLoad(void);
int EDT_pcscEstablishContext(void);
int EDT_pcscLogReaderList(void);
int EDT_pcscLogCardList(void);
